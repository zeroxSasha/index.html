        ...
        <section className="About">
            <div className="About__text-block">
                ...
                <div className='About__desc'>
                    <p>I'm a passionate programmer, who always ready for solving various types of problems. My enthusiasm helps me discover and learn new technologies. You can always rely on me.</p>
